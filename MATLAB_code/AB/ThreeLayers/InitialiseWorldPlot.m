...
%text(retailersPositions(:,1), retailersPositions(:,2), ...
    %'horizontal','left', 'vertical','bottom'); %retailersLabels, 
...
%text(warehousesPositions(:,1), warehousesPositions(:,2), ...
   % 'horizontal','left', 'vertical','bottom'); % warehousesLabels,
...
%text(manufacturersPositions(:,1), manufacturersPositions(:,2), ...
   % 'horizontal','left', 'vertical','bottom'); % manufacturersLabels, 
